...
<?php get_header(); ?>
			<div id="content" class="grid_12">
				...
				$wp_query->query("post_type=portfolio&". $catinclude ."&paged=".$paged.'&showposts=12');
				...
				<div id="gallery" class="four_columns">
					<ul class="portfolio rlist clearfix">
						<?php $i=1;
						if ( have_posts() ) while ( have_posts() ) : the_post(); 
							...
							<li class="<?php echo $addclass; ?>">
								...
								$image = aq_resize( $img_url, 190, 160, true ); //resize & crop img
								...
								<div class="folio-desc">
									...
									<div class="excerpt"><?php $excerpt = get_the_excerpt(); echo my_string_limit_words($excerpt,7);?></div>
								</div>
							</li>
							<?php $i++; $addclass = "";
						endwhile; ?>
