				...
				<li>
					<div class="clearfix header-title">
						...
						<div class="extra-wrap">
							...
							<h6><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php _e('Permanent Link to', 'theme1918');?> <?php the_title_attribute(); ?>"><?php the_title(); ?></a></h6>
						</div>
					</div>
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo $this->get_field_id('category'); ?>">
				<?php _e('Category Slug:', 'theme1918'); ?>
		...
		<p>
			<label for="<?php echo $this->get_field_id('post_format'); ?>">
				<?php _e('Post format:', 'theme1918'); ?><br>
		...
		<p>
			<label for="<?php echo $this->get_field_id('sort_by'); ?>">
				<?php _e('Post order:', 'theme1918'); ?><br>
		...
		<p>
			<label for="<?php echo $this->get_field_id('excerpt_count'); ?>">
				...
				<input class="widefat" style="width:30px; display:block; text-align:center" id="<?php echo $this->get_field_id('excerpt_count'); ?>" name="<?php echo $this->get_field_name('excerpt_count'); ?>" type="text" value="<?php echo $excerpt_count; ?>">
			</label>
		</p>
		<p>
			<label for="<?php echo $this->get_field_id('linktext'); ?>">
				<?php _e('Link Text:', 'theme1918'); ?> 
