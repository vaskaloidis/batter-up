...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		<ul class="social-networks<?php echo $class;?> rlist">
	...
	function form( $instance ) {
		...
		<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			...
			<p>
				<label for="<?php echo $this->get_field_id('linkedin_label'); ?>"><?php _e('Linkedin label:'); ?></label>
		...
		<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			...
			<p>
				<label for="<?php echo $this->get_field_id('delicious_label'); ?>"><?php _e('Delicious label:'); ?></label>
				<input class="widefat" id="<?php echo $this->get_field_id('delicious_label'); ?>" name="<?php echo $this->get_field_name('delicious_label'); ?>" type="text" value="<?php echo esc_attr($delicious_label); ?>">
			</p>
		</fieldset>
		...
		<fieldset style="border:1px solid #dfdfdf; padding:10px 10px 0; margin-bottom:1em;">
			...
			<p>
				<label for="<?php echo $this->get_field_id('youtube_label'); ?>"><?php _e('Youtube label:'); ?></label>
